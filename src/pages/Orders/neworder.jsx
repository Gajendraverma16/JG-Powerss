                ...
                {isEditMode ? (
                  <>
                    {budgetItems.map((item, idx) => (
                      <div
                        key={idx}
                        className="grid grid-cols-1 md:grid-cols-[1.5fr_0.5fr_0.5fr_0.1fr_1fr] gap-y-2 md:gap-y-0 py-2 text-[10px] md:text-sm text-gray-700 items-center"
                      >
...
<div className="relative w-full" data-product-dropdown>
  ...
  {productDropdownOpenIndex === idx && (
    isMobileView ? (
      // Mobile: full-screen modal-style dropdown
      ...
      // Desktop / larger screens: inline absolute dropdown
      <div className="absolute z-30 top-full left-0 w-full bg-white  rounded-lg mt-1 max-h-56 overflow-y-auto shadow-lg">
        ...
        {!productsLoading && getFilteredProducts(productSearchTerm).length === 0 && (
          <div className="p-3 text-xs text-gray-500">No product found.</div>
                        ...
                        {/* Mobile compact qty/price shown at right of product name */}
                        <div className="ml-3 flex flex-col items-end md:hidden space-y-1 text-sm">
                          <input
                            type="number"
                            min="1"
                            value={item.qty}
                            ...
                            className="text-center border-b border-gray-300 outline-none px-1 bg-transparent w-16"
                            placeholder="Qty"
                          />
                          <div className="text-sm text-gray-700">₹{item.rate}</div>
                        </div>
                        </div>
...
/>
                        ...
                        <div className="whitespace-nowrap pr-0 text-gray-700 flex md:justify-end gap-4">
                           <span>
  ...
  <span>
                  ...
                  <>
                    {budgetItems.map((item, idx) => (
                      <div
                        key={idx}
                        className="grid grid-cols-1 md:grid-cols-[1.5fr_0.5fr_0.5fr_0.1fr_1fr] gap-y-2 md:gap-y-0 py-1 md:py-2 text-sm text-gray-700"
                      >
  ...
  <span>
     { (parseFloat(item.qty) * parseFloat(item.points) || 0).toLocaleString() }
                ...
                <div className="grid grid-cols-1 md:grid-cols-[1.5fr_0.5fr_0.5fr_0.1fr_1fr] text-[8px] md:text-sm font-bold bg-gray-100 text-gray-700 whitespace-nowrap">
                  <div className="md:p-2.5 p-1">Sub total</div>
                  <div></div>
                  <div></div>
                  <div className="whitespace-nowrap pl-0 pt-2.5 md:pl-50 md:pt-0 flex md:justify-end gap-4">
                    <span>
                      Rs {calculateBudgetSubtotal().toLocaleString(undefined, {
                ...
                <div className="grid grid-cols-1 md:grid-cols-[1.5fr_0.5fr_0.5fr_0.1fr_1fr] font-bold text-[8px] md:text-base">
                  <div className="pl-1 md:pl-4 border-t-2 border-[#0e4053] pt-2.5 text-gray-700">TOTAL</div>
                  <div className="border-t-2 border-[#0e4053]"></div>
                  <div className="border-t-2 border-[#0e4053]"></div>
                  <div></div>
                  <div className="whitespace-nowrap pr-0 text-gray-700 border-t-2 border-[#0e4053] pt-2.5 flex md:justify-end">
                    <span>
                      Rs {calculateBudgetSubtotal().toLocaleString(undefined, {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
