...
const handleProductSelect = (product, rowIndex) => {
  ...
  const submitQuotation = async () => {
    ...
    const items = budgetItems
      ...
      .map((item) => ({
        ...
        points:item.points,
        order_status: 2,
      item_id: item.item_id || "", // Default status
      }));
  ...
  const addBudgetItem = () => {
    setBudgetItems((prev) => [...prev, { description: "", qty: 0, rate: 0, item_id: "" }]);
  };
...
export default ReturnQuotationCreate;