...
const ViewProducts = () => {
  ...
  // Search / responsive state (keeps UI consistent with AllLeads)
  ...
  // Search handlers to mirror AllLeads behavior (mobile toggle, blur, change)
  const handleSearchToggle = () => {
    setIsSearchExpanded(!isSearchExpanded);
  };

  const handleSearchBlur = () => {
    // collapse the mobile search input when it loses focus
  ...
  // Reset to first page when search term or itemsPerPage change
  useEffect(() => {
    setCurrentPage(1);
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.5 15.5L19 19M5 11a6 6 0 1112 0 6 6 0 01-12 0z" />
                </svg>
              </button>
              ...
              {isSearchExpanded && (
                <div className="flex-1">
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#ef7e1b] outline-none"
                    autoFocus
                  />
                </div>
              )}
          ...
          <>
            ...
            <div className="hidden md:block overflow-x-auto">
              <table className="min-w-full text-sm text-left border-collapse">
                ...
                <tr key={product.id} className="hover:bg-[#E7EFF8] transition">
            ...
            <div key={product.id} className="bg-white rounded-lg shadow p-4 space-y-3">
              ...
              <div className="flex space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-sm font-medium text-gray-900 truncate">{product.item_name}</h3>
                  <p className="text-sm text-gray-500">₹{product.sale_price || product.regular_price}</p>
